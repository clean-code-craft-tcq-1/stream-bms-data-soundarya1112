...
def bms_parameters_generation():
        bms_params = {}
        bms_params["temperature"] = round(random.uniform(battery_allowedValues['temperature']['min'],battery_allowedValues['temperature']['max']),2)
        bms_params["state_of_charge"] = round(random.uniform(battery_allowedValues['state_of_charge']['min'], battery_allowedValues['state_of_charge']['max']),2)
        bms_params["charge_rate"] = round(random.uniform(battery_allowedValues['charge_rate']['min'], battery_allowedValues['charge_rate']['max']),2)   
        return bms_params
